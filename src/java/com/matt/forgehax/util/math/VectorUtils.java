...
public class VectorUtils implements Globals
{
    ...
    public static Plane toScreen(final double x, final double y, final double z) {
        ...
        VectorUtils.modelMatrix.load(((FloatBuffer)FastReflection.Fields.ActiveRenderInfo_MODELVIEW.getStatic()).asReadOnlyBuffer());
        VectorUtils.projectionMatrix.load(((FloatBuffer)FastReflection.Fields.ActiveRenderInfo_PROJECTION.getStatic()).asReadOnlyBuffer());
        ...
        return new Plane((double)pos.x, (double)pos.y, bVisible);
    }
